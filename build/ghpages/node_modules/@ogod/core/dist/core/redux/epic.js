...
import { addToScene, initializeInstance, loadEngineScene, loadInstance, loadResource, loadScene, startEngine, updateInstances } from "./action.js";
...
const engineLoadedEpic = (action$, state$) => action$.pipe(ofType('ENGINE_LOADED'), map(({
  payload
}) => startEngine(payload.id)));
...
let epics = [resourceCreateSharedEpic, resourceCreateEpic, resourceLoadEpic, instanceCreateEpic, instanceAddToSceneEpic, instanceLoadEpic, instanceLoadedEpic, sceneCreateEpic, sceneLoadEpic, sceneNavEpic, engineLoadEpic, engineLoadedEpic, engineStartEpic];
