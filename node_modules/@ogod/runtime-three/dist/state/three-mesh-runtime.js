...
export class ThreeMeshRuntime extends DefaultInstanceRuntime {
  ...
  changes(entity, changes) {
    if (changes.geometry && this.instance.geometry != changes.geometry) {
      this.instance.geometry = changes.geometry;
    }

    if (changes.material && this.instance.material != changes.material) {
      this.instance.material = changes.material;
    }

    return super.changes(entity, changes);
  }
